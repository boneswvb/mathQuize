...
function Addition(){
  var playerAnswer = prompt(a[0].toUpperCase() + a.slice(1) + "," +" what is the answer of: " + randomMathTable + " + " + randomMathTableJ);
...
function multiply(){
  var playerAnswer = prompt(a[0].toUpperCase() + a.slice(1) + "," +" what is the answer of: " + randomMathTable + " x " + randomMathTableJ);
  answer = Number(randomMathTable) * Number(randomMathTableJ);
  scoreTotal++;
...
mainOptionMathOption(multiply);
 ...
 function devision(){
   ...
   var playerAnswer = prompt(a[0].toUpperCase() + a.slice(1) + "," +" what is the answer of; " + divisionTotal + " / " + randomMathTableJ);
 ...
 mainOptionMathOption(devision);
  ...
  function sq(){
   var playerAnswer = prompt(a[0].toUpperCase() + a.slice(1) + "," +" what is the Square root of; " + randomMathTableSq);
...
if(answer.toString() === playerAnswer.toString()){
 ...
 mainOptionMathOption(sq);
  alert("score " + score + " out of " + scoreTotal);
}
